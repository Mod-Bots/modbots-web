...
// The footer for the pages behind the room. It carries the published policy
// set, which is how a reader reaches the cookie notice from anywhere.
export const BackPageFooter = (): React.ReactElement => {
