...
function ParticipantRow({
  ...
  return (
    <div className="modbots-participant-row flex items-center gap-3 rounded-xl px-2 py-1.5 hover:bg-white/[0.04]">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p
          className={`modbots-participant-status mt-0.5 text-[10px] font-medium uppercase tracking-[0.08em] ${currentStatus.text}`}
          data-status={status}
        >
        ...
        <div className="modbots-print-chat-layout relative flex min-h-0 flex-1">
          {!entered ? (
            ...
            <>
              {membersOpen ? (
                <aside
                  className={`modbots-participants-panel fixed bottom-7 left-0 top-11 z-40 w-[min(88vw,340px)] shrink-0 flex-col border-r border-white/[0.08] bg-modbots-panel shadow-[20px_0_60px_rgba(0,0,0,0.5)] lg:static lg:z-auto lg:flex lg:w-[var(--participants-width)] lg:shadow-none ${
                ...
                >
                  <div className="modbots-participants-header flex h-[68px] shrink-0 items-center border-b border-white/[0.08] px-5">
                  ...
                  <div className="modbots-participants-summary flex shrink-0 items-center gap-2 border-b border-white/[0.06] px-5 py-2 text-zinc-400">
                  ...
                  <div className="modbots-participants-list modbots-scroll min-h-0 flex-1 overflow-y-auto p-3">
                    <div className="space-y-4">
                      {roster.map((group) => (
                        <div
                          key={group.type}
                          className="modbots-participant-group"
                        >
                          <p className="modbots-participant-group-title px-2 pb-1 text-[11px] font-semibold uppercase tracking-[0.1em] text-zinc-600">
                  ...
                  <div className="modbots-account-dock relative shrink-0 border-t border-white/[0.08] p-3">
                    {userMenuOpen &&
                    localActor !== undefined &&
                    localProfile !== null ? (
                      <div
                    ...
                    <div className="modbots-account-card flex items-center gap-1 rounded-window border border-white/[0.06] bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-1.5 shadow-[0_12px_36px_rgba(0,0,0,0.22)]">
                      <button
                        type="button"
                        onClick={() =>
                          localActor === undefined
